...
class ParseQuery {
  ...
  include() {
    ...
    (0, _forEach.default)(keys).call(keys, key => {
      if ((0, _isArray.default)(key)) {
        var _context11;
        this._include = (0, _concat.default)(_context11 = this._include).call(_context11, key);
      } else {
  ...
  select() {
    ...
    (0, _forEach.default)(keys).call(keys, key => {
      if ((0, _isArray.default)(key)) {
        var _context12;
        this._select = (0, _concat.default)(_context12 = this._select).call(_context12, key);
      } else {
  ...
  exclude() {
    ...
    (0, _forEach.default)(keys).call(keys, key => {
      if ((0, _isArray.default)(key)) {
        var _context13;
        this._exclude = (0, _concat.default)(_context13 = this._exclude).call(_context13, key);
      } else {
  ...
  watch() {
    ...
    (0, _forEach.default)(keys).call(keys, key => {
      if ((0, _isArray.default)(key)) {
        var _context14;
        this._watch = (0, _concat.default)(_context14 = this._watch).call(_context14, key);
      } else {
