  ...
  return (0, _createClass2.default)(ParseObject, [{
    ...
    value: function (attrs) {
      ...
      for (var _key in attrs) {
        if (!/^[A-Za-z_][0-9A-Za-z_.]*$/.test(_key)) {
          return new _ParseError.default(_ParseError.default.INVALID_KEY_NAME, `Invalid key name: ${_key}`);
        }
      }
      return false;
    }
    ...
    value: function () {
      var _save = (0, _asyncToGenerator2.default)(function* (arg1, arg2, arg3) {
        ...
        yield controller.save(unsaved, saveOptions);
